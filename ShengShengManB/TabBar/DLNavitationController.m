...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.viewControllers.count > 1) {  // 如果是非根控制器
        ...
        // 设置返回按钮
        viewController.navigationItem.leftBarButtonItem = [UIBarButtonItem CreateItemWithTarget:self ForAction:@selector(backClick) WithImage:@"BACK-arrow" WithHighlightImage:nil];
    }
}
