...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        chooseButton.titleLabel.font = H15;
...
-(void)configButtonClick
{
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(didClickFinishDateTimePickerView:datepick:)]) {
        [self.delegate didClickFinishDateTimePickerView:_string datepick:self];
    }
